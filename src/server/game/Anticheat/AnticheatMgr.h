...
class AnticheatMgr
{
    ...
    public:
        ...
        std::string TypeToString(const uint8 type) const;
    ...
    private:
        ...
        void BroadCastGameMasters(Player* player, std::string text) const;
...
#define REPORT_TIME_THRESHOLD 3 * IN_MILLISECONDS
